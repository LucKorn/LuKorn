  ...
  if (tela === 'treino') {
    return (
      <View style={styles.container}>
        ...
        {timerAtivo && (
          <View style={styles.timerFlutuante}><Text style={styles.timerFlutuanteText}>Descanso: {segundos}s</Text></View>
        )}
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      ...
      {Object.keys(exercicios).map((t) => (
        <TouchableOpacity key={t} style={styles.btnMenu} onPress={() => { setTreinoAtivo(t); setTela('treino'); }}>
